            ...
            <>
              ...
              >
                ...
                >
                  ...
                  {!sidebarCollapsed && <span className="truncate">Users</span>}
                </button>
              </Tooltip>
              ...
              >
                ...
                >
                  ...
                  {!sidebarCollapsed && <span className="truncate">Templates</span>}
                </button>
              </Tooltip>
              ...
              >
                ...
                >
                  ...
                  {!sidebarCollapsed && <span className="truncate">Company</span>}
                </button>
              </Tooltip>
            </>
          )}
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="lg:hidden flex items-center justify-between px-4 h-14 border-b border-divider bg-background/80 backdrop-blur-lg sticky top-0 z-40 print:hidden">
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu aria-label="User menu">
              <DropdownItem key="info" className="h-14 gap-2" textValue="User Info">
                <p className="font-semibold">{user.name}</p>
                <p className="text-sm text-default-500 capitalize">{user.role.toLowerCase()}</p>
              </DropdownItem>
              {user.role === "ADMIN" ? (
                <>
