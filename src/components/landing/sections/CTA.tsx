...
export function CTA() {
  return (
    <section id="cta" className="relative py-24 sm:py-32 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(37,99,235,0.06),transparent_60%)]" aria-hidden />
      ...
      <div className="relative mx-auto max-w-4xl px-5 sm:px-8 text-center">
        <motion.h2
          ...
          className="font-display text-[42px] sm:text-[68px] font-medium leading-[1.0] tracking-tight text-slate-900"
        >
        ...
        <motion.p
          ...
          className="mt-5 text-[16.5px] text-slate-500 max-w-xl mx-auto leading-relaxed"
        >
        ...
        <motion.div
          ...
          className="mt-10 flex flex-wrap items-center justify-center gap-x-7 gap-y-3 text-[12.5px] text-slate-400"
        >
          <span className="flex items-center gap-1.5">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#2563eb" strokeWidth="2.4" strokeLinecap="round"><path d="m5 12 5 5L20 7"/></svg>
            No credit card
          </span>
          <span className="flex items-center gap-1.5">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#2563eb" strokeWidth="2.4" strokeLinecap="round"><path d="m5 12 5 5L20 7"/></svg>
