...
export function UdharSection() {
  ...
  return (
    <section id="udhar" className="relative py-24 sm:py-32 overflow-hidden border-t border-slate-200/60">
      <div className="absolute -top-20 right-0 w-[400px] h-[400px] bg-[radial-gradient(closest-side,rgba(217,119,6,0.06),transparent_70%)] blur-3xl" aria-hidden />
            ...
            {bullets.map((b, i) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-[14px] font-medium text-slate-800">{b.t}</h3>
                </div>
                <p className="mt-1.5 text-[12.5px] text-slate-500 leading-relaxed">{b.d}</p>
              </motion.div>
            ))}
          </div>
        </div>
