  ...
  return (
    <PhoneFrame>
      ...
      <div className="px-5 pt-2 pb-3 flex items-center justify-between">
        ...
        <span className="font-mono text-[10px] text-[#60a5fa]">BILL-202605-018</span>
      </div>
      ...
      <div className="mt-4 px-5">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-[10px] text-[#60a5fa] font-medium">+ Add item</span>
        </div>
      ...
      <div className="absolute bottom-0 inset-x-0 px-5 pb-6 pt-4 bg-gradient-to-t from-[#07090a] via-[#07090a] to-transparent">
        <div className="rounded-2xl border border-[#2563eb]/20 bg-[#2563eb]/[0.06] p-4">
          ...
          <div className="flex items-baseline justify-between">
            ...
            <span className="text-[22px] font-semibold text-[#60a5fa]">₹{total.toLocaleString("en-IN")}</span>
          </div>
        </div>
        <div className="mt-3 flex gap-2">
          <button className="flex-1 rounded-full bg-[#2563eb] text-white font-semibold text-[13px] py-3">
            Pakka karo
          </button>
