...
export function PhoneFrame({
  ...
  return (
    <div className={`relative ${className}`}>
      {glow && (
        <>
          <div className="absolute -inset-10 bg-[radial-gradient(closest-side,rgba(40,224,168,0.18),transparent_70%)] blur-2xl" aria-hidden />
          <div className="absolute -inset-16 bg-[radial-gradient(closest-side,rgba(217,150,86,0.12),transparent_70%)] blur-3xl" aria-hidden />
        </>
      )}
      <div className="relative mx-auto w-[320px] sm:w-[360px] md:w-[380px] rounded-[3rem] border border-white/10 bg-gradient-to-b from-[#0f1316] to-[#07090a] p-3 shadow-[0_60px_120px_-30px_rgba(0,0,0,0.8)]">
        ...
        <div className="relative h-[640px] sm:h-[700px] overflow-hidden rounded-[2.4rem] bg-[#0a0d10] ring-1 ring-white/5">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(40,224,168,0.06),transparent_60%)]" aria-hidden />
          {children}
        </div>
      </div>
    </div>
